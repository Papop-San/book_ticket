...
describe('BookService', () => {
  ...
  describe('create', () => {
    it('should create booking successfully', async () => {
      ...
      mockDbService.query
        ...
        .mockResolvedValueOnce([{ id: 1, seat_id: 1, name: 'John Doe', email: 'alice@example.com', status: BookingStatus.BOOKED }]) // INSERT
  ...
  describe('update', () => {
    it('should update booking successfully', async () => {
      mockDbService.query.mockResolvedValueOnce([{ id: 1, seat_id: 1, name: 'Updated User', email: 'a@b.com', status: BookingStatus.BOOKED }]);
  ...
  describe('getEventBookings', () => {
    it('should return bookings grouped by event', async () => {
      const mockEvents = [{ id: 1, capacity: 10 }, { id: 2, capacity: 10 }];
      const mockBookings1 = [{ name: 'Alice Smith', email: 'alice@example.com', status: BookingStatus.BOOKED }];
      const mockBookings2 = [
      ...
      expect(result).toEqual([
        { event_id: 1, bookings: mockBookings1, availableSeats: 9, status: 'Available' },
        { event_id: 2, bookings: mockBookings2, availableSeats: 8, status: 'Available' },
      ]);
    });
  });
});
